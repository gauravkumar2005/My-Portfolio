function Navbar() {
  return (
    <div className="w-full bg-white/80 backdrop-blur-md flex flex-col md:flex-row items-center justify-between px-4 sm:px-6 md:px-10 py-4 md:py-5 gap-2 md:gap-0 shadow-md fixed top-0 z-50 border-b border-gray-200">
